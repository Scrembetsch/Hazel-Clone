...
namespace Device
{
    ...
    public:
        ...
        inline static const int NUM_KEYS = sf::Keyboard::Key::KeyCount + 1;	// Offset because Key can be -1
	...
	private:
		inline static bool mKeyDown[NUM_KEYS];
		inline static bool mKeyReleased[NUM_KEYS];
		inline static bool mKeyPressed[NUM_KEYS];
	};
}